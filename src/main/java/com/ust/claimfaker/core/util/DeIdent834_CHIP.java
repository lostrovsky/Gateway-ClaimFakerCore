		...
		scanner = new Scanner(new BufferedReader(new java.io.FileReader(InputFileName)));
			...
			//System.err.println("LINE: " + counter);
			 ...
			 outfile.println(segment);
        		 ...
        		 if(prevSeg.startsWith("NM1*IL") || 
        				 prevSeg.startsWith("NM1*7") || 
        				 prevSeg.startsWith("NM1*QD")
 ...
 *
						 ...
						 ) segment = FakeHPP834.fakeN4(thisHPP834.NM1, seg,faker);
						 */
        		  segment = seg;
        		 prevSeg = null;
    			 outfile.println(segment);
			 ...
			 //  PER*RP**HP*2159101357*WP*2154005075~
			 ...
			 else if(seg.startsWith("REF*3H*")) {
        		 thisHPP834.setREFIL(seg);
        		 segment = FakeHPP834.fakeREF3h(thisHPP834.REF3h, seg, faker);
    			 outfile.println(segment);
        	 }
			 else if(seg.startsWith("REF*23*")) {
        		 thisHPP834.setREFIL(seg);
        		 segment = FakeHPP834.fakeREF23(thisHPP834.REF23, seg, faker);
    			 outfile.println(segment);
        	 }
        		 ...
        		 thisHPP834.setREFIL(seg);
        		 segment = FakeHPP834.fakeREFzzAll9(thisHPP834.REFzz, seg, faker);
    			 outfile.println(segment);
