...
import com.ust.claimfaker.core.util.DbFakeHPP834EDIchp;
import com.ust.claimfaker.core.util.getRandomAddressPool;

public class FakeHPP820 {

	
	
	
	public static String fakeENT(String segv, Faker faker) {
		...
		String niner = segmentArray[4].substring(0, 9);
		String check = segmentArray[4].substring(9, 10);

		String padded = DbFakeHPP834EDIchp.findFake("numeric", "String", niner,faker);
		segmentArray[4] = padded + check;
...
*/
	...
	public static String fakeREF0f(String segnm, String segv,Faker faker) {
		...
		String refVal = DbFakeHPP834EDIchp.findFake("numeric9", "String", segmentArray[2],faker);
...
public static String fakeREFzz(String segnm, String segv,Faker faker) {
	...
	//KEEP the S mask 
		...
		if(segmentArray[2].startsWith("S")) {
			...
			refVal = "S" + DbFakeHPP834EDIchp.findFake("numeric9", "String", actualREF, faker);

			
		}
		else {
			
			refVal = DbFakeHPP834EDIchp.findFake("numeric9", "String", segmentArray[2], faker);
