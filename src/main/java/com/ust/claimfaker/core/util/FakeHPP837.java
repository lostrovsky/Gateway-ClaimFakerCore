...
public class FakeHPP837 {
	...
	public static String fakeNM1(String segnm, String segv, Faker faker) {
		...
		String filetypesize =  segType + segmentArray[9].length(); 
		
		
		
		String SSN = DbFakeHPP834EDIchp.findFake(filetypesize, "String", segmentArray[9].toUpperCase(),faker);
	...
	public static String fakeREFea(String segnm, String segv,Faker faker) {
		...
		try {
	        double d = Double.parseDouble(segmentArray[2]);
	        eA = "numeric" + segmentArray[2].length();
	    } catch (NumberFormatException | NullPointerException nfe) {
	        eA = "alpha" + segmentArray[2].length();
	        
	    }
		

		
		String refVal = DbFakeHPP834EDIchp.findFake(eA, "String", segmentArray[2],faker);
