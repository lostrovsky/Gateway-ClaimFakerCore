...
public class FakeHPP835 {

	
	
	public static String fakeNM1QC(String segnm, String segv, Faker faker) {
		...
		//If numeric10 do numeric9 and passthrought check digit
				String check = null;
				if(segmentArray[9].length() == 10) {
					segv =   segmentArray[9].substring(0, 9);
					check = segmentArray[9].substring(9, segmentArray[9].length());
				}
							
		
				//String refVal = DbFakeHPP834EDIchp.findFake("numeric9", "String", segmentArray[9],faker);
				
				String refVal = DbFakeHPP834EDIchp.findFake("numeric", "String", segv,faker);

				
				
				if(check != null) segmentArray[9] = refVal + check;
				else  segmentArray[9] = refVal;

	
		/*
				faker.idNumber().ssnValid().replaceAll("\\.", "").replaceAll("-", "").replaceAll("\\(", "")
	...
	*/
	...
	public static String fakeNM1IL(String segnm, String segv, Faker faker) {
			...
			String eA = null;
			try {
		        double d = Double.parseDouble(segmentArray[9]);
		        eA = "numeric" + segmentArray[9].length();
		    } catch (NumberFormatException | NullPointerException nfe) {
		        eA = "alpha" + segmentArray[9].length();
		        
		    }
						
			String refVal = DbFakeHPP834EDIchp.findFake(eA, "String", segmentArray[9],faker);
...
*/
	...
	public static String fakeREF0f(String segnm, String segv,Faker faker) {
		...
		if(segmentArray[2].length() == 10) {
			segv =   segmentArray[2].substring(0, 9);
...
public static String fakeREFea(String segnm, String segv,Faker faker) {
...
public static String fakeREFsy(String segnm, String segv,Faker faker) {
