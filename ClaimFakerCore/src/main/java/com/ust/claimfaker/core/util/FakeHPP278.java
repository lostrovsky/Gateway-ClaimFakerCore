...
public class FakeHPP278 {
	...
	*/
	...
	public static String fakeNM1IL(String segnm, String segv, Faker faker) {
			...
			// else System.out.println("\n\n\nLEN:" + segmentArray.length + "\n\n\n");
			if (segmentArray.length >= 6) segmentArray[5] = middleInitial;
			...
			String refVal = null;
			if (segmentArray.length >= 9)  {
				refVal = DbFakeHPP834EDIchp.findFake("numeric", "String", segmentArray[9],faker);
				segmentArray[9]=refVal;
			}
